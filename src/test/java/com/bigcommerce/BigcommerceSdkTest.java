...
public class BigcommerceSdkTest {
  ...
  public void givenStoreHashAndClientIdAndAccessTokenWhenBuildingBigcommerceSdkThenReturnBigcommerceSdkWithCorrectValues() {
    final BigcommerceSdk actualBigcommerceSdk = BigcommerceSdk.newBuilder()
        .withStoreHash(SOME_STORE_HASH)
  ...
  @Test
  public void givenValidCredentialsWhenRetrievingCatalogSummaryThenReturnCatalogSummary()
    ...
    driver.addExpectation(
        onRequestTo(expectedPath).withHeader(BigcommerceSdk.CLIENT_ID_HEADER, SOME_CLIENT_ID)
            .withHeader(BigcommerceSdk.ACCESS_TOKEN_HEADER, SOME_ACCESS_TOKEN)
    ...
    assertEquals(expectedCatalogSummary.getHighestVariantPrice(),
        actualCatalogSummary.getHighestVariantPrice());
    assertEquals(expectedCatalogSummary.getInventoryCount(),
        actualCatalogSummary.getInventoryCount());
    assertEquals(expectedCatalogSummary.getVariantCount(), actualCatalogSummary.getVariantCount());
    assertEquals(expectedCatalogSummary.getAverageVariantPrice(),
        actualCatalogSummary.getAverageVariantPrice());
    assertEquals(expectedCatalogSummary.getInventoryValue(),
        actualCatalogSummary.getInventoryValue());
  }
  ...
  public void givenSomePageWhenRetrievingProductsThenReturnProducts() throws JAXBException {
    ...
    final List<Product> expectedProducts = Arrays
        .asList(firstExpectedProduct, secondExpectedProduct);
    ...
    assertEquals(expectedPagination.getCurrentPage(),
        actualProducts.getPagination().getCurrentPage());
    ...
    assertEquals(expectedPagination.getTotalPages(),
        actualProducts.getPagination().getTotalPages());
  }
  ...
  public void givenSomeProductWhenCreatingProductsThenCreateProduct() throws JAXBException {
    ...
    assertEquals(expectedProduct.getVariants().get(0).getPrice(),
        actualProduct.getVariants().get(0).getPrice());
    assertEquals(expectedProduct.getVariants().get(0).getWeight(),
        actualProduct.getVariants().get(0).getWeight());
    assertEquals(expectedProduct.getVariants().get(0).getSku(),
        actualProduct.getVariants().get(0).getSku());
    assertEquals(expectedProduct.getVariants().get(0).getUpc(),
        actualProduct.getVariants().get(0).getUpc());
    ...
    assertEquals(expectedProduct.getVariants().get(1).getPrice(),
        actualProduct.getVariants().get(1).getPrice());
    assertEquals(expectedProduct.getVariants().get(1).getWeight(),
        actualProduct.getVariants().get(1).getWeight());
    assertEquals(expectedProduct.getVariants().get(1).getSku(),
        actualProduct.getVariants().get(1).getSku());
    assertEquals(expectedProduct.getVariants().get(1).getUpc(),
        actualProduct.getVariants().get(1).getUpc());
  ...
  @Test
  public void givenSomeProductImageWhenCreatingProductImageThenCreateProductImage()
      throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
  ...
  @Test
  public void givenSomeProductImageWhenUpdatingProductImageThenUpdateProductImage()
      throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    ...
    final String expectedPath = new StringBuilder().append(FORWARD_SLASH).append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V3).append(FORWARD_SLASH)
        .append("catalog/products/").append(someProductId).append("/images/").append(someImageId)
        .toString();
  ...
  @Test
  public void givenSomeProductIdAndSomeVariantIdWhenDeletingVariantThenDeleteVariant()
      throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    ...
    final String expectedPath = new StringBuilder().append(FORWARD_SLASH).append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V3).append(FORWARD_SLASH)
        .append("catalog/products/").append(expectedProductId).append("/variants/")
        .append(expectedVariantId)
        .toString();
  ...
  public void givenSomeVariantWithInvalidIdWhenUpdatingVariantThenThrowNewBigcommerceErrorResponseException() {
    ...
    final String expectedPath = new StringBuilder().append(FORWARD_SLASH).append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V3).append(FORWARD_SLASH)
        .append("catalog/products/").append(productId).append("/variants/").append(variantId)
        .toString();
  ...
  public void givenSomePageWhenRetrievingOrdersThenReturnOrders()
    ...
    final DateTimeFormatter formatter = DateTimeFormat
        .forPattern(DateTimeAdapter.RFC_822_DATE_FORMAT);
    ...
    assertEquals(expectedOrders.get(0).getBaseHandlingCost(),
        actualOrders.get(0).getBaseHandlingCost());
    assertEquals(expectedOrders.get(0).getBaseShippingCost(),
        actualOrders.get(0).getBaseShippingCost());
    assertEquals(expectedOrders.get(0).getBaseWrappingCost(),
        actualOrders.get(0).getBaseWrappingCost());
    assertEquals(expectedOrders.get(0).getCouponDiscount(),
        actualOrders.get(0).getCouponDiscount());
    assertEquals(expectedOrders.get(0).getCreditCardType(),
        actualOrders.get(0).getCreditCardType());
    assertEquals(expectedOrders.get(0).getCurrencyCode(), actualOrders.get(0).getCurrencyCode());
    assertEquals(expectedOrders.get(0).getCurrencyExchangeRate(),
        actualOrders.get(0).getCurrencyExchangeRate());
    ...
    assertEquals(expectedOrders.get(1).getBaseHandlingCost(),
        actualOrders.get(1).getBaseHandlingCost());
    assertEquals(expectedOrders.get(1).getBaseShippingCost(),
        actualOrders.get(1).getBaseShippingCost());
    assertEquals(expectedOrders.get(1).getBaseWrappingCost(),
        actualOrders.get(1).getBaseWrappingCost());
    assertEquals(expectedOrders.get(1).getCouponDiscount(),
        actualOrders.get(1).getCouponDiscount());
    assertEquals(expectedOrders.get(1).getCreditCardType(),
        actualOrders.get(1).getCreditCardType());
    assertEquals(expectedOrders.get(1).getCurrencyCode(), actualOrders.get(1).getCurrencyCode());
    assertEquals(expectedOrders.get(1).getCurrencyExchangeRate(),
        actualOrders.get(1).getCurrencyExchangeRate());
  ...
  public void givenSomePageWhenRetrievingOrdersAndDateInTheFutureThenReturnNoContent() {
    ...
    final Status expectedStatus = Status.NO_CONTENT;
    final int expectedStatusCode = expectedStatus.getStatusCode();
    final DateTime futureDate = DateTime.parse("2018-07-18T00:00:00.000Z")
        .toDateTime(DateTimeZone.UTC);
    driver.addExpectation(
        onRequestTo(expectedPath).withHeader(BigcommerceSdk.CLIENT_ID_HEADER, SOME_CLIENT_ID)
            .withHeader(BigcommerceSdk.ACCESS_TOKEN_HEADER, SOME_ACCESS_TOKEN).withParam("page", 1)
            .withParam("limit", 250).withParam("min_date_created", futureDate.toString())
            .withMethod(Method.GET),
        giveEmptyResponse().withStatus(expectedStatusCode)).anyTimes();
  ...
  public void givenOrderWithShipmentsThenReturnShipments() throws JAXBException {
    ...
    final List<Shipment> expectedShipments = Arrays
        .asList(firstExpectedShipment, secondExpectedShipment,
    ...
    assertEquals(expectedShipments.get(0).getShippingMethod(),
        actualShipments.get(0).getShippingMethod());
    assertEquals(expectedShipments.get(0).getShippingProvider(),
        actualShipments.get(0).getShippingProvider());
    assertEquals(expectedShipments.get(0).getTrackingNumber(),
        actualShipments.get(0).getTrackingNumber());

    assertEquals(expectedShipments.get(1).getShippingMethod(),
        actualShipments.get(1).getShippingMethod());
    assertEquals(expectedShipments.get(1).getShippingProvider(),
        actualShipments.get(1).getShippingProvider());
    assertEquals(expectedShipments.get(1).getTrackingNumber(),
        actualShipments.get(1).getTrackingNumber());

    assertEquals(expectedShipments.get(0).getShippingMethod(),
        actualShipments.get(2).getShippingMethod());
    assertEquals(expectedShipments.get(0).getShippingProvider(),
        actualShipments.get(2).getShippingProvider());
    assertEquals(expectedShipments.get(0).getTrackingNumber(),
        actualShipments.get(2).getTrackingNumber());
  ...
  public void givenAShipmentThenCreateAShipment() throws JAXBException {
    ...
    final List<ShipmentLineItem> expectedShipmentLineItems = Arrays
        .asList(expectedShipmentLineItem1);
    ...
    assertEquals(actualShipment.getTrackingCarrier(),
        shipmentCreationRequest.getRequest().getTrackingCarrier());
    assertEquals(actualShipment.getShippingProvider(),
        shipmentCreationRequest.getRequest().getShippingProvider());
    assertEquals(actualShipment.getOrderAddressId(),
  ...
  public void givenAShipmentThenUpdateAShipment() throws JAXBException {
    ...
    assertEquals(actualShipment.getTrackingCarrier(),
        shipmentUpdateRequest.getRequest().getTrackingCarrier());
    assertEquals(actualShipment.getShippingProvider(),
        shipmentUpdateRequest.getRequest().getShippingProvider());
    assertEquals(actualShipment.getOrderAddressId(),
        shipmentUpdateRequest.getRequest().getOrderAddressId());
  ...
  public void givenBigcommerceSdkAndStatusNameThenReturnOrderStatus() throws JAXBException {
    ...
    final OrderStatus actualOrderStatus = bigcommerceSdk
        .getStatus(com.bigcommerce.catalog.models.Status.COMPLETED);
  ...
  public void givenAnOrderWhenCompletingOrderThenSetOrderStatusToComplete() throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    final String expectedPathCompleteOrder = new StringBuilder().append(FORWARD_SLASH)
        .append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V2).append(FORWARD_SLASH)
        .append("orders")
        .append(FORWARD_SLASH).append(SOME_ORDER_ID).toString();

    final String expectedPathOrderStatuses = new StringBuilder().append(FORWARD_SLASH)
        .append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V2).append(FORWARD_SLASH)
        .append("order_statuses").toString();
    ...
    driver.addExpectation(
        onRequestTo(expectedPathOrderStatuses)
            .withHeader(BigcommerceSdk.CLIENT_ID_HEADER, SOME_CLIENT_ID)
            .withHeader(BigcommerceSdk.ACCESS_TOKEN_HEADER, SOME_ACCESS_TOKEN)
            .withMethod(Method.GET),
    ...
    completeOrderMarshaller
        .setProperty(MarshallerProperties.MEDIA_TYPE, MediaType.APPLICATION_JSON);
    ...
    driver.addExpectation(
        onRequestTo(expectedPathCompleteOrder)
            .withHeader(BigcommerceSdk.CLIENT_ID_HEADER, SOME_CLIENT_ID)
            .withHeader(BigcommerceSdk.ACCESS_TOKEN_HEADER, SOME_ACCESS_TOKEN)
            .withMethod(Method.PUT),
  ...
  public void givenAnOrderWhenCancellingAnOrderThenSetOrderStatusToCancel() throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    final String expectedPathCancelOrder = new StringBuilder().append(FORWARD_SLASH)
        .append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V2).append(FORWARD_SLASH)
        .append("orders")
        .append(FORWARD_SLASH).append(SOME_ORDER_ID).toString();
    ...
    driver.addExpectation(
        onRequestTo(expectedPathCancelOrder)
            .withHeader(BigcommerceSdk.CLIENT_ID_HEADER, SOME_CLIENT_ID)
            .withHeader(BigcommerceSdk.ACCESS_TOKEN_HEADER, SOME_ACCESS_TOKEN)
            .withMethod(Method.PUT),
        giveResponse(expectedCompleteOrderResponseBodyString, MediaType.APPLICATION_JSON)
  ...
  public void givenCatalogWithBrandsThenReturnBrands() throws JAXBException {
    ...
    final List<Brand> expectedBrands = Arrays
        .asList(firstExpectedBrand, secondExpectedBrand, thirdExpectedBrand);
    ...
    assertEquals(expectedBrands.get(0).getImageUrl(),
        actualBrands.getBrands().get(0).getImageUrl());
    assertEquals(expectedBrands.get(0).getPageTitle(),
        actualBrands.getBrands().get(0).getPageTitle());
    assertEquals(expectedBrands.get(0).getSearchKeywords(),
        actualBrands.getBrands().get(0).getSearchKeywords());
    assertEquals(expectedBrands.get(0).getMetaDescription(),
        actualBrands.getBrands().get(0).getMetaDescription());
    assertEquals(expectedBrands.get(0).getMetaKeywords(),
        actualBrands.getBrands().get(0).getMetaKeywords());
    ...
    assertEquals(meta.getPagination().getTotalPages(),
        actualBrands.getPagination().getTotalPages());
    assertEquals(meta.getPagination().getCurrentPage(),
        actualBrands.getPagination().getCurrentPage());
  ...
  public void givenSomeProductMetafiedAndProductIdAndMetafieldIdWhenUpdatingProductMetafieldsThenUpdateAndReturnProductMetafield()
    ...
    final String expectedPath = new StringBuilder().append(FORWARD_SLASH).append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V3).append(FORWARD_SLASH)
        .append("catalog/products/").append(expectedProductId).append("/metafields/")
        .append(expectedId)
        .toString();
    ...
    final Metafield actualMetafield = bigcommerceSdk
        .updateProductMetafield(expectedProductId, expectedId,
            expectedProductMetafield);
  ...
  @Test
  public void givenSomeProductIdWhenRetrievingMetafieldsThenReturnMetafields()
      throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    ...
    final Metafield firstExpectedMetafield = buildMetafield(1, "productId",
        UUID.randomUUID().toString(),
        "channelape", "some description1", expectedProductId);
    final Metafield secondExpectedMetafield = buildMetafield(2, "imageUrl",
        UUID.randomUUID().toString(),
        "channelape", "some description2", expectedProductId);
    final Metafield thirdExpectedMetafield = buildMetafield(3, "testField",
        UUID.randomUUID().toString(),
        "channelape", "some description3", expectedProductId);

    final List<Metafield> expectedMetafields = Arrays
        .asList(firstExpectedMetafield, secondExpectedMetafield,
    ...
    final Metafields actualMetafields = bigcommerceSdk
        .getProductMetafields(expectedProductId, 1, 250);
    assertEquals(expectedMetafields.get(0).getResourceId(),
        actualMetafields.getMetafields().get(0).getResourceId());
    assertEquals(expectedMetafields.get(0).getId(),
        actualMetafields.getMetafields().get(0).getId());
    assertEquals(expectedMetafields.get(0).getKey(),
        actualMetafields.getMetafields().get(0).getKey());
    assertEquals(expectedMetafields.get(0).getValue(),
        actualMetafields.getMetafields().get(0).getValue());
    assertEquals(expectedMetafields.get(0).getDescription(),
        actualMetafields.getMetafields().get(0).getDescription());
    assertEquals(expectedMetafields.get(0).getNamespace(),
        actualMetafields.getMetafields().get(0).getNamespace());

    assertEquals(meta.getPagination().getTotal(), actualMetafields.getPagination().getTotal());
    assertEquals(meta.getPagination().getTotalPages(),
        actualMetafields.getPagination().getTotalPages());
    assertEquals(meta.getPagination().getCurrentPage(),
        actualMetafields.getPagination().getCurrentPage());
    assertEquals(meta.getPagination().getPerPage(), actualMetafields.getPagination().getPerPage());

  }

  @Test
  public void givenSomeProductIdAndSomePageWhenRetrievingProductImagesThenReturnProductImages()
      throws JAXBException {
    final BigcommerceSdk bigcommerceSdk = buildBigcommerceSdk();
    ...
    assertEquals(expectedProductImages.get(0).getId(),
        actualProductImages.getProductImages().get(0).getId());
  ...
  public void givenSomeProductIdAndSomeProductImageIdWhenDeletingProductImagesThenDeleteProductImage()
    ...
    final String expectedPath = new StringBuilder().append(FORWARD_SLASH).append(SOME_STORE_HASH)
        .append(FORWARD_SLASH).append(BigcommerceSdk.API_VERSION_V3).append(FORWARD_SLASH)
        .append("catalog/products/").append(expectedProductId).append("/images/").append(expectedId)
        .toString();
  ...
  private Metafield buildMetafield(final Integer id, final String key, final String value,
  ...
  private BigcommerceSdk buildBigcommerceSdk() {
    ...
    return BigcommerceSdk.newSandboxBuilder().withApiUrl(apiUrl)
        .withRequestRetryTimeout(20, TimeUnit.MILLISECONDS)
        .withStoreHash(SOME_STORE_HASH).withClientId(SOME_CLIENT_ID)
        .withAccessToken(SOME_ACCESS_TOKEN).build();
  }
}
