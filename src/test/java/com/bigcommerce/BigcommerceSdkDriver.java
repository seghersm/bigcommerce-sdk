...
public class BigcommerceSdkDriver {
  ...
  public void givenShipmentRequestThenCreateShipment() {
    ...
    assertEquals(shipment.getTrackingNumber(),
        shipmentCreationRequest.getRequest().getTrackingNumber());
  ...
  public void givenShipmentRequestThenUpdateShipment() {
    ...
    assertNotNull(shipment);
    assertEquals(shipment.getTrackingNumber(),
        shipmentUpdateRequest.getRequest().getTrackingNumber());
  ...
  public void givenBrandWhenCreateBrandThenCreateBrand() {
    ...
    expectedBrand
        .setImageUrl("https://www.channelape.com/wp-content/themes/ChannelApe/images/logo.png");
